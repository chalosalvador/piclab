...
const AppBar = () => {
  return (
    <div className="flex bg-white rounded-md w-appbar fixed bottom-4 z-40 py-2 px-6 md:px-2 left-1/2 transform -translate-x-1/2 drop-shadow-lg justify-between">
